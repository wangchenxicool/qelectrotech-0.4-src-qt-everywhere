...
void QETApp::systray (QSystemTrayIcon::ActivationReason reason)
{
    ...
    case QSystemTrayIcon::Trigger:
        ...
        if (every_editor_reduced) restoreEveryEditor();
        else reduceEveryEditor();
        break;
...
{
    //QMessageBox::about(NULL, "About", "QETApp::projectsRecentFiles");
...
{
    //QMessageBox::about(NULL, "About", "QETApp::elementsRecentFiles");
...
{
    //QMessageBox::about(NULL, "About", "openFiles");
...
{
    //QMessageBox::about(NULL, "About", "openProjectFiles");
...
{
    //QMessageBox::about(NULL, "About", "openElementFiles");
...
{
    //QMessageBox::about(NULL, "About", "openElementLocations");
...
{
    //QMessageBox::about(NULL, "About", "openTitleBlockTemplate");
...
{
    //QMessageBox::about(NULL, "About", "openTitleBlockTemplateFiles");
    if (files_list.isEmpty()) return;
